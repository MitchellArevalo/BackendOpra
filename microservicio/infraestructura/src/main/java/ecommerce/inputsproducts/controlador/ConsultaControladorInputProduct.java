...
@Tag(name = "Controlador consulta inputs")
public class ConsultaControladorInputProduct {
    ...
    public ConsultaControladorInputProduct(ManejadorObtenerListaDeInputProducts manejadorObtenerListaDeInputProducts, ManejadorObtenerInputProductById manejadorObtenerInputProductById, ManejadorObtenerInputsProductByIdProduct manejadorObtenerInputsProductByIdProduct) {
